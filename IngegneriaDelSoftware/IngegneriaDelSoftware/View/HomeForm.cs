    ...
    public partial class HomeForm: MaterialForm {
        ...
        private void riempiAppuntamenti() {
            ...
            this._controller.AppuntamentiDiOggi().ForEach((a) => {
                this.AppunamentiList.Items.Add(new ListViewItem(new string[] { String.Format("{0} {1}", a.DataOra.ToShortDateString(), a.DataOra.ToShortTimeString()), a.Note , a.Luogo.ToString(), "" + a.ConChi?.getDenominazione() }));
            });
        }
